...
<body class="text-center">
	<form class="form-signin" action="/forum/login" method="post">
		...
		<label for="inputEmail" class="sr-only">usuario</label> <input
			type="text" id="inputEmail" name="usuario" class="form-control"
		...
		<div class="col-xs-6">
			<a href="cadastrarUsuario.jsp" id="register-form-link">Register</a>
		</div>
		</div>
