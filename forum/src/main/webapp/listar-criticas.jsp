...
<body>
	...
	<nav class="navbar fixed-top navbar-dark bg-dark">
 		 ...
 		 <form class="form-inline" action="/forum/Sair" method="post">
	...
	<div class="container  span7  col-md-11 col-md-offset-3" style="margin: 0 auto; margin-top:100px; marginfloat: none; border: 1px solid gray">
		...
		<form class="col-md-6" action='/forum/filtrar-critica.jsp'>
		  <div class="form-group" >
		   ...
		   <a href='/forum/listar-criticas.jsp?numPagina=1' class="btn btn-primary" style="margin-bottom: 10px">Limpar</a>
	...
	<div style="margin-left: 55px; margin-top: 10px;">
		<form>
			<div style="color: white;">
			  	<a href='/forum/cadastrar-critica.jsp' type="submit" class="btn btn-primary">Cadastrar nova Crítica</a>
			  </div>
		</form>
	</div>
	...
	<table class="table table-striped table-active col-md-11 ">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a href='/forum/visualizar-critica.jsp?id=<%=c.getId() %>' class="btn btn-success" style="color: white;">Visualizar</a>
					<a href='/forum/alterar-critica.jsp?id=<%=c.getId() %>' class="btn btn-secondary" style="color: white;">Editar</a>
					<a href='/forum/Excluir?id=<%=c.getId() %>' class="btn btn-danger" style="color: white;">Excluir</a>
				</td>
			</tr>
			<%} %>
		</tbody>
	...
	<nav aria-label="Page navigation example">
	  <ul class="pagination justify-content-center">
	    <li class="page-item">
	      <a class="page-link" href="/forum/listar-criticas.jsp?numPagina=<%=Integer.parseInt(numPagina) - 1%>" tabindex="-1">Voltar</a>
	    </li>
	    <li class="page-item">
	      <a class="page-link" href="/forum/listar-criticas.jsp?numPagina=<%=Integer.parseInt(numPagina) + 1%>">Próximo</a>
	    </li>
	  </ul>
	</nav>
